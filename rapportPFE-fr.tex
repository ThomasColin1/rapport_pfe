...
Les produits se classent en deux catégories : les produits normaux, qui constituent un logiciel à part entière téléchargeables, et les "bundle", qui sont des paquets de logiciels Arturia, qui sont rassemblés car on peut les acheter ensemble. Le bundle possède alors une licence qui lui est propre, et dans ses détails, l'utilisateur peut retrouver l'ensemble des produits qui le constituent. De plus, il a l'option de tous les télécharger en même temps.
...
\begin{itemize}
    ...
    \item De plus, les boutons de téléchargement en cours et de téléchargement en pause doivent afficher, sur survolage de souris, des options de pause et d'arrêt du téléchargement.
