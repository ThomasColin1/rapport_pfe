...
L'Arturia Software Center (ASC) et le Midi Control Center (MCC) en font partie, et sont respectivement le gestionnaire de logiciels et licenses, et le logiciel de configuration d'appareils physiques d'Arturia.
...
\begin{itemize}
    ...
    \item Expérimenter l'utilisation de l'API Web USB pour mettre à jour en Device Firmware Update les appareils Arturia.
\end{itemize}
...
Au démarrage de l'application, l'application qui affiche le navigateur, affiche la page principale de GeMAPS, que l'on va appeler la page Unified Control Center (UCC).
...
\begin{itemize}
    \item Le point majeur d'erreur que j'ai fait dans ce stage a été de commencer mon projet sur un langage que personne ne maîtrise ni n'utilise
\end{itemize}
% API Web USB
